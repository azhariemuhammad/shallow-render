...
describe('Renderer', () => {
  ...
  describe('structural directives', () => {
    it('returns the first child element when testing a structural directive', async () => {
    ...
    it('returns undefined when the structural directive does not render an element', async () => {
      const myRenderer = new Renderer(new TestSetup(NgIf, TestModule));
    ...
    it('returns the directive instance when testing a structural directive', async () => {
      const myRenderer = new Renderer(new TestSetup(NgIf, TestModule));
